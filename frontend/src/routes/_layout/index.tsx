  ...
  return (
    <div style={{ padding: "40px", maxWidth: "860px" }}>
      <div style={{ marginBottom: "40px" }}>
        <p style={{ fontSize: "13px", color: "#7878A0", margin: "0 0 4px" }}>
          {greeting()},
        </p>
        <h1
          style={{
        ...
        <p style={{ fontSize: "12px", color: "#4A4A6A", margin: 0 }}>
        ...
        {[
          ...
          >
            ...
            >
              ...
              <span style={{ fontSize: "11px", color: "#7878A0" }}>
                {stat.label}
              </span>
            </div>
            <span
        ...
        {[
          {
            icon: FiPlus,
            label: "Create a Note",
            desc: "Capture thoughts, ideas, and knowledge instantly",
            to: "/items",
            color: "#7C6AF7",
          },
          {
            icon: FiCpu,
            label: "Ask AI",
            desc: "Query your notes with natural language questions",
            to: "/ai",
            color: "#34D399",
          },
        ].map((action) => (
