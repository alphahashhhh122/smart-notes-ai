    ...
    <div style={s.card}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.current_password && (
          <p style={s.error}>{errors.current_password.message}</p>
        )}
        ...
        />
        {errors.new_password && (
          <p style={s.error}>{errors.new_password.message}</p>
        )}
        ...
        <input
          ...
          {...register("confirm", {
            validate: (v) =>
              v === watch("new_password") || "Passwords don't match",
          })}
        />
  ...
  return (
    <div>
      <div style={s.card}>
        ...
        <p style={s.cardSub}>
          Permanently delete your account and all your notes. This cannot be
          undone.
        </p>
      ...
      {confirm && (
        <div style={s.confirmOverlay} onClick={() => setConfirm(false)}>
          <div style={s.confirmBox} onClick={(e) => e.stopPropagation()}>
            <p
              style={{ ...s.cardTitle, fontSize: "16px", marginBottom: "8px" }}
            >
            ...
            >
              ...
              <strong style={{ color: "#E8E8F0" }}>{user?.email}</strong> and
            ...
            <div style={s.row}>
              ...
              <button style={s.ghostBtn} onClick={() => setConfirm(false)}>
                Cancel
              </button>
            </div>
          </div>
