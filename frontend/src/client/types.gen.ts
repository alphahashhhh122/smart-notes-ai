...
export type AskNotesRequest = {
    question: string;
};

export type AskNotesResponse = {
    answer: string;
    sources: Array<AskNotesSource>;
};

export type AskNotesSource = {
    id: string;
    title: string;
    snippet?: (string | null);
};
...
export type AiAskNotesData = {
    requestBody: AskNotesRequest;
};

export type AiAskNotesResponse = (AskNotesResponse);
